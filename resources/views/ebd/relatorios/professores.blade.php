...
@section('breadcrumb')
    <x-breadcrumb :breadcrumbs="[
        ...
        ['text' => 'Professores', 'url' => '#', 'active' => true],
    ]"></x-breadcrumb>
@endsection
    ...
    <div class="col-12 layout-spacing">
        <div class="statbox widget box box-shadow">
            ...
            <div class="widget-content widget-content-area">
                <form method="GET" action="{{ route('ebd.relatorios.professores') }}" class="mb-4 ebd-filtros">
                    <div class="row">
                        ...
                        <div class="col-md-12 mt-2 filtro-acoes">
                            ...
                            <a href="{{ route('ebd.relatorios.professores') }}" class="btn btn-secondary">Limpar</a>
                        </div>
                    </div>
                </form>

                <div class="table-responsive">
                    <table class="table table-bordered table-sm display nowrap" id="ebd-relatorio-professores" style="width: 100%;">
                        <thead>
                            <tr>
                                <th>Nome</th>
                                <th>CPF</th>
...
@section('extras-scripts')
    ...
    <script>
        new DataTable('#ebd-relatorio-professores', {
            pageLength: 25,
            order: [[0, 'asc']],
            layout: {
                topStart: {
