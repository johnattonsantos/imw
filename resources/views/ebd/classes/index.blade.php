...
@section('content')
    ...
    <div class="container-fluid d-flex justify-content-between">
        <div>
            <a href="{{ route('ebd.classes.create') }}" class="btn btn-primary position-relative mt-3 mb-3 ml-2">
                ...
                <span class="ml-2">NOVA CLASSE</span>
            </a>
        </div>
    </div>
                            ...
                            @forelse ($classes as $item)
                                <tr>
                                    ...
                                    <td class="d-flex" style="gap: .5rem;">
                                        <a href="{{ route('ebd.classes.edit', $item->id) }}" class="btn btn-sm btn-dark mr-2 btn-rounded bs-tooltip" title="Editar" aria-label="Editar">
