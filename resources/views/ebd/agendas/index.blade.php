...
@section('content')
    ...
    <div class="container-fluid d-flex justify-content-between">
        <div>
            <a href="{{ route('ebd.agendas.create') }}" class="btn btn-primary position-relative mt-3 mb-3 ml-2">
                            ...
                            @forelse ($agendas as $item)
                                <tr>
                                    ...
                                    <td class="d-flex" style="gap: .5rem;">
                                        <a href="{{ route('ebd.agendas.edit', $item->id) }}" class="btn btn-sm btn-dark mr-2 btn-rounded bs-tooltip" title="Editar" aria-label="Editar">
