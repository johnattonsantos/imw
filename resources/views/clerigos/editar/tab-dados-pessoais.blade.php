        ...
        <div class="row mb-4">
            ...
            <div class="col-xl-9">
                <div class="form-group @error('nome') has-error @enderror">
                    ...
                    <div class="row mb-4">
                        @php
                            $situacaoSelecionada = $situacoes->firstWhere('id', old('situacao', $clerigo->situacao_id));
                        ...
                        <div class="col-xl-4">
                            ...
                            <input type="text" class="form-control @error('cpf') is-invalid @enderror" id="cpf"
                                name="cpf" value="{{ old('cpf', $clerigo->cpf) }}" maxlength="18" @unless($cpfOpcional) required @endunless>
                            @error('cpf')
                                <span class="help-block text-danger">{{ $message }}</span>
                            @enderror
                        </div>
                         ...
                         <div class="col-xl-4">
                            ...
                            <select class="form-control  @error('situacao') is-invalid @enderror" type="text"
                                ...
                                @foreach($situacoes as $situacao)
                                    <option value="{{ $situacao->id }}" data-cpf-opcional="{{ $situacao->cpfOpcional() ? '1' : '0' }}" {{ $situacao->id == old('situacao', $clerigo->situacao_id) ? 'selected' : '' }}>{{ $situacao->descricao }}</option>
                                @endforeach
                            </select>
                            @error('situacao')
                                <span class="help-block text-danger">{{ $message }}</span>
