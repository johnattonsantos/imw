...
<x-breadcrumb :breadcrumbs="[
    ...
    ['text' => 'Administração', 'url' => route('admin.index'), 'active' => false],
    ['text' => 'Pesquisar Membro', 'url' => route('admin.pesquisar-membro'), 'active' => true],
]"></x-breadcrumb>
@endsection
        ...
        <div class="widget-header">
            <div class="row">
                <div class="col-xl-12 col-md-12 col-sm-12 col-12">
                    ...
                    <p class="pl-3 mb-0">{{ __('Busque membros por nome ou CPF.') }}</p>
                </div>
            </div>
        </div>

        <div class="widget-content widget-content-area">
            <form method="GET" action="{{ route('admin.pesquisar-membro') }}" class="mb-4">
                <div class="row align-items-end">
                    ...
                    <div class="col-lg-4 col-md-4 mb-2">
                        ...
                        <a href="{{ route('admin.pesquisar-membro') }}" class="btn btn-light btn-rounded">
                            {{ __('Limpar') }}
                        </a>
                    </div>
                </div>
