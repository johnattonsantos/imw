...
@section('breadcrumb')
    <x-breadcrumb :breadcrumbs="[
        ...
        ['text' => 'EBD - Diário', 'url' => '#', 'active' => true],
    ]"></x-breadcrumb>
@endsection
        ...
        <div class="statbox widget box box-shadow">
            <div class="widget-header">
                <div class="row">
                    <div class="col-xl-12 col-md-12 col-sm-12 col-12">
                        <h4>Relatório EBD - Diário (Distrital)</h4>
                    </div>
                </div>
            </div>
            <div class="widget-content widget-content-area">
                <form method="GET" class="form-vertical ebd-filtros">
                    <div class="row">
                        ...
                        <div class="col-lg-3 col-md-6">
                            ...
                            <select name="periodo_aula" class="form-control">
                                <option value="">Todos</option>
                ...
                <div class="table-responsive">
                    <table class="table table-bordered table-striped display nowrap" id="ebd-regional-diarios-table" style="width: 100%;">
                        <thead>
                            <tr>
                                <th>Distrito</th>
                                <th>Igreja</th>
                        ...
                        <tbody>
                            @foreach ($diarios as $item)
                                <tr>
                                    <td>{{ $item->turma->professor->membro->distrito->nome ?? '-' }}</td>
                                    <td>{{ $item->turma->professor->membro->igreja->nome ?? '-' }}</td>
...
@section('extras-scripts')
    ...
    <script>
        ...
        new DataTable('#ebd-regional-diarios-table', {
            order: [[2, 'desc']],
            pageLength: 25,
            layout: {
                topStart: {
                    buttons: [
                        { extend: 'excel', className: 'btn btn-primary btn-rounded', text: '<i class="fas fa-file-excel"></i> Excel', title: 'IMW - RELATÓRIO EBD DIÁRIO (DISTRITAL)' },
                        { extend: 'pdfHtml5', orientation: 'landscape', pageSize: 'A4', className: 'btn btn-primary btn-rounded', text: '<i class="fas fa-file-pdf"></i> PDF', title: 'IMW - RELATÓRIO EBD DIÁRIO (DISTRITAL)' }
                    ]
                },
                topEnd: 'search',
                bottomStart: 'info',
