...
@section('breadcrumb')
    <x-breadcrumb :breadcrumbs="[
        ...
        ['text' => 'EBD - Professores', 'url' => '#', 'active' => true],
    ]"></x-breadcrumb>
@endsection
        ...
        <div class="statbox widget box box-shadow">
            <div class="widget-header">
                <div class="row">
                    <div class="col-xl-12 col-md-12 col-sm-12 col-12">
                        <h4>Relatório EBD - Professores (Distrital)</h4>
                    </div>
                </div>
            </div>
            <div class="widget-content widget-content-area">
                ...
                <div class="table-responsive">
                    <table class="table table-bordered table-striped display nowrap" id="ebd-regional-professores-table" style="width: 100%;">
                        <thead>
                            <tr>
                                <th>Distrito</th>
                                <th>Igreja</th>
...
@section('extras-scripts')
    ...
    <script>
        ...
        new DataTable('#ebd-regional-professores-table', {
                    ...
                    buttons: [
                        {
                            ...
                            title: 'IMW - RELATÓRIO EBD PROFESSORES (DISTRITAL)'
                        },
                        {
                            extend: 'pdfHtml5',
