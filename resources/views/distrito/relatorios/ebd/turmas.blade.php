            ...
            <div class="widget-header">
                <div class="row">
                    <div class="col-xl-12 col-md-12 col-sm-12 col-12">
                        <h4>Relatório de EBDs (Distrital)</h4>
                    </div>
                </div>
            </div>
    ...
    <script>
        ...
        new DataTable('#ebd-regional-turmas-table', {
            ...
            layout: {
                topStart: {
                    buttons: [
                        { extend: 'excel', className: 'btn btn-primary btn-rounded', text: '<i class="fas fa-file-excel"></i> Excel', title: 'IMW - RELATÓRIO EBD TURMAS (DISTRITAL)' },
                        { extend: 'pdfHtml5', orientation: 'landscape', pageSize: 'A4', className: 'btn btn-primary btn-rounded', text: '<i class="fas fa-file-pdf"></i> PDF', title: 'IMW - RELATÓRIO EBD TURMAS (DISTRITAL)' }
                    ]
                },
                topEnd: 'search',
                bottomStart: 'info',
