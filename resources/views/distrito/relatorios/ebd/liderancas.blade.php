...
@section('breadcrumb')
    <x-breadcrumb :breadcrumbs="[
        ...
        ['text' => 'EBD - Liderança', 'url' => '#', 'active' => true],
    ]"></x-breadcrumb>
@endsection
        ...
        <div class="statbox widget box box-shadow">
            <div class="widget-header">
                <div class="row">
                    <div class="col-xl-12 col-md-12 col-sm-12 col-12">
                        <h4>Relatório EBD - Liderança (Distrital)</h4>
                    </div>
                </div>
            </div>
            <div class="widget-content widget-content-area">
                <form method="GET" class="form-vertical ebd-filtros">
                    <div class="row">
                        ...
                        <div class="col-lg-2 col-md-4">
                            ...
                            <input type="text" name="cargo" value="{{ $filters['cargo'] ?? '' }}" class="form-control"
                ...
                <div class="table-responsive">
                    <table class="table table-bordered table-striped display nowrap" id="ebd-regional-liderancas-table" style="width: 100%;">
                        <thead>
                            <tr>
                                <th>Distrito</th>
                                <th>Igreja</th>
...
@section('extras-scripts')
    ...
    <script>
        ...
        new DataTable('#ebd-regional-liderancas-table', {
                    ...
                    buttons: [
                        {
                            ...
                            title: 'IMW - RELATÓRIO EBD LIDERANÇA (DISTRITAL)'
                        },
                        {
                            extend: 'pdfHtml5',
