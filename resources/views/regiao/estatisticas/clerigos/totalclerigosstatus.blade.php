                        ...
                        <div class="row">
                            <div class="col-12">
                                ...
                                @include('regiao.partials.table-export-buttons', [
                                    'tableId' => 'total-clerigos-status-table',
                                    'title' => 'Total Clérigos por situação status - ' . $regiao->nome,
                                    'filename' => 'total-clerigos-por-situacao-status',
                                    'sheetName' => 'Clérigos Status',
                                ])
                                <div class="table-responsive">
                                    <table id="total-clerigos-status-table" class="table table-striped" style="font-size: 90%; margin-top: 15px;">
