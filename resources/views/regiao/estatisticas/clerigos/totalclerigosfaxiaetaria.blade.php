                        ...
                        <div class="row">
                            <div class="col-12">
                                ...
                                @include('regiao.partials.table-export-buttons', [
                                    'tableId' => 'total-clerigos-faixa-etaria-table',
                                    'title' => 'Total Clérigos por Faixa Etária - ' . $regiao->nome,
                                    'filename' => 'total-clerigos-por-faixa-etaria',
                                    'sheetName' => 'Clérigos Faixa',
                                ])
                                <div class="table-responsive">
                                    <table id="total-clerigos-faixa-etaria-table" class="table table-striped" style="font-size: 90%; margin-top: 15px;">
                                        <thead class="thead-dark">
                                            <tr>
                                                <th style="text-align: left;">{{ __('Faxia Etária') }}</th>
