                        ...
                        <div class="row">
                            <div class="col-12">
                                ...
                                @include('regiao.partials.table-export-buttons', [
                                    'tableId' => 'total-clerigos-vinculo-table',
                                    'title' => 'Total Clérigos por tipo vínculo - ' . $regiao->nome,
                                    'filename' => 'total-clerigos-por-tipo-vinculo',
                                    'sheetName' => 'Clérigos Vínculo',
                                ])
                                <div class="table-responsive">
                                    <table id="total-clerigos-vinculo-table" class="table table-striped" style="font-size: 90%; margin-top: 15px;">
