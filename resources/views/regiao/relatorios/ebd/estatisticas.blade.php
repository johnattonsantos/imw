...
<div class="col-lg-12 col-12 layout-spacing">
    <div class="statbox widget box box-shadow">
        ...
        <div class="widget-content widget-content-area">
            <form method="GET" class="form-vertical" id="filtro-estatisticas-ebd">
            ...
            <div class="table-responsive">
                <table class="table table-bordered table-striped display nowrap" id="estatisticas-ebd-regiao" style="width: 100%;">
                    <thead>
                        <tr>
                            <th>Distrito</th>
                            <th>Igreja</th>
...
@section('extras-scripts')
    ...
    <script>
        ...
        igrejaSelect?.addEventListener('change', function () {
            document.getElementById('filtro-estatisticas-ebd').submit();
        });

        new DataTable('#estatisticas-ebd-regiao', {
            order: [[2, 'desc']],
            pageLength: 25,
            layout: {
                topStart: {
                    buttons: [
                        {
                            ...
                            title: 'IMW - RELATÓRIO ESTATÍSTICAS EBD (REGIONAL)'
                        },
                        {
                            extend: 'pdf',
