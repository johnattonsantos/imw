        ...
        <div class="statbox widget box box-shadow">
            ...
            <div class="widget-content widget-content-area">
                ...
                <div class="row">
                    @php
                        $cards = [
                            ['titulo' => 'Liderança', 'total' => $totalLiderancas, 'rota' => route('regiao.relatorio.ebd.liderancas')],
                            ['titulo' => 'Professores', 'total' => $totalProfessores, 'rota' => route('regiao.relatorio.ebd.professores')],
                            ['titulo' => 'Alunos', 'total' => $totalAlunos, 'rota' => route('regiao.relatorio.ebd.alunos')],
                            ['titulo' => 'Classes', 'total' => $totalClasses, 'rota' => route('regiao.relatorio.ebd.classes')],
