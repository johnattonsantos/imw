...
@section('breadcrumb')
    <x-breadcrumb :breadcrumbs="[
        ...
        ['text' => 'Clérigo por Igreja', 'url' => '#', 'active' => true],
    ]"></x-breadcrumb>
@endsection
...
@section('content')
            ...
            <div class="widget-header">
                <div class="row">
                    <div class="col-xl-12 col-md-12 col-sm-12 col-12">
                        <h4>{{ __('Relatório Clérigo por Igreja') }}</h4>
                    </div>
                </div>
            </div>
    ...
    @if (request()->has('action'))
        <div class="col-lg-12 col-12 layout-spacing">
            <h6>IMW - RELATÓRIO CLÉRIGO POR IGREJA - REGIÃO {{ strtoupper($regiao->nome) }}</h6>
            <div class="statbox widget box box-shadow">
                <div class="widget-content widget-content-area">
                    <div class="table-responsive mt-0">
                        <table class="table table-bordered table-striped table-hover mb-4 display nowrap" id="clerigo-por-igreja">
                            <thead>
                                <tr>
                                    <th>{{ __('CLÉRIGO') }}</th>
                                    <th>{{ __('DISTRITO') }}</th>
...
@section('extras-scripts')
    ...
    <script>
        ...
        @if(request()->has('action'))
            new DataTable('#clerigo-por-igreja', {
                scrollX: true,
                scrollY: 400,
                scrollCollapse: true,
                layout: {
                    topStart: {
                        buttons: [
                            'pageLength',
                            {
                                ...
                                title: 'IMW - RELATORIO CLERIGO POR IGREJA'
                            },
                            {
                                extend: 'pdf',
                                className: 'btn btn-primary btn-rounded',
