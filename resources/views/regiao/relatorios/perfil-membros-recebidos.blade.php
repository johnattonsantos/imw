...
<x-breadcrumb :breadcrumbs="[
    ...
    ['text' => 'Perfil dos Membros Recebidos', 'url' => route('regiao.relatorio.perfil-membros-recebidos'), 'active' => true],
]"></x-breadcrumb>
@endsection
...
@php
  ...
  $tituloRelatorio = 'PERFIL DOS MEMBROS RECEBIDOS - ' . $regiao->nome . ' - ' . $periodoInicial . ' A ' . $periodoFinal;
@endphp
...
<div class="col-lg-12 col-12 layout-spacing">
  <div class="statbox widget box box-shadow">
    <div class="widget-header">
      <div class="row">
        <div class="col-12">
          <h4>Perfil dos Membros Recebidos</h4>
    ...
    <div class="widget-content widget-content-area">
      ...
      <div class="table-responsive">
        <table class="table table-bordered table-striped table-hover mb-4 display nowrap" id="perfil-membros-recebidos-table" style="width: 100%;">
          <thead>
            <tr>
              <th>DISTRITO</th>
              <th>IGREJA</th>
          ...
          <tbody>
            @foreach ($membros as $membro)
              <tr>
                ...
                <td>{{ $membro->modo_recepcao ?: 'Não informado' }}</td>
                <td>{{ \Carbon\Carbon::parse($membro->data_recepcao)->format('d/m/Y') }}</td>
              </tr>
            @endforeach
          </tbody>
          <tfoot>
...
<script>
  ...
  new DataTable('#perfil-membros-recebidos-table', {
    pageLength: 25,
        ...
        buttons: [
          ...
          },
          {
            ...
            customize: function (doc) {
              ...
              if (tableNode) {
                tableNode.table.widths = ['12%', '12%', '15%', '5%', '8%', '11%', '8%', '12%', '10%', '7%'];
              }
            }
          }
        ]
    ...
    language: {
      decimal: ',',
      thousands: '.',
      emptyTable: 'Nenhum membro recebido no período',
      ...
      search: 'Pesquisar',
      zeroRecords: 'Nenhum membro recebido no período',
