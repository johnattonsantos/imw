                                ...
                                <div class="col-12">
                                    ...
                                    <div class="table-responsive">
                                        <table class="table table-striped display nowrap"
                                            id="igrejas-mais-cresceram-membros"
                                            style="font-size: 90%; margin-top: 15px; width: 100%;">
                                            <thead class="thead-dark">
                                                <tr>
                                                    <th style="text-align: left;">{{ __('Igrejas') }}</th>
                                                    <th style="text-align: center;">{{ __('Quantide de Membros Recebidos') }}</th>
...
@section('extras-scripts')
    ...
    <script>
        $(document).ready(function() {
            ...
            if ($('#igrejas-mais-cresceram-membros').length) {
                new DataTable('#igrejas-mais-cresceram-membros', {
                    scrollX: true,
                    layout: {
                        topStart: {
                            buttons: [
