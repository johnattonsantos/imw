                            ...
                            <div class="row">
                                <div class="col-12">
                                    ...
                                    <div class="table-responsive">
                                        <table class="table table-striped display nowrap" id="distritos-mais-batismo"
...
@section('extras-scripts')
    ...
    <script>
        $(document).ready(function() {
            ...
            if ($('#distritos-mais-batismo').length) {
                new DataTable('#distritos-mais-batismo', {
                    scrollX: true,
                    layout: {
                        topStart: {
                            buttons: [
                                'pageLength',
                                {
                                    ...
                                    titleAttr: 'Excel',
                                    title: 'IMW - 10+ DISTRITOS QUE BATIZARAM'
                                },
                                {
                                    extend: 'pdfHtml5',
                                    className: 'btn btn-primary btn-rounded',
                                        ...
                                        doc.header = function() {
                                            return {
                                                columns: [{
                                                    alignment: 'center',
                                                    italics: false,
                                                    text: 'IMW - 10+ DISTRITOS QUE BATIZARAM',
                                                    fontSize: 14
                                                }],
                                                margin: [20, 20, 0, 0]
                                            };
