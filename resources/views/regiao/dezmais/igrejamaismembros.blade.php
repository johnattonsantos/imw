                            ...
                            <div class="row">
                                <div class="col-12">
                                    ...
                                    <div class="table-responsive">
                                        <table class="table table-striped display nowrap" id="igrejas-mais-membros"
                                            style="font-size: 90%; margin-top: 15px; width: 100%;">
                                            <thead class="thead-dark">
                                                <tr>
                                                    <th style="text-align: left;">{{ __('Igrejas') }}</th>
                                                    <th style="text-align: center;">{{ __('Quantide de Membros') }}</th>
...
@section('extras-scripts')
    ...
    <script>
        $(document).ready(function() {
            ...
            if ($('#igrejas-mais-membros').length) {
                new DataTable('#igrejas-mais-membros', {
                    scrollX: true,
                    layout: {
                        topStart: {
                            buttons: [
                                'pageLength',
                                {
                                    ...
                                    titleAttr: 'Excel',
                                    title: 'IMW - 10+ IGREJAS EM NÚMEROS DE MEMBROS'
                                },
                                {
                                    extend: 'pdfHtml5',
                                    className: 'btn btn-primary btn-rounded',
                                        ...
                                        doc.header = function() {
                                            return {
                                                columns: [{
                                                    alignment: 'center',
                                                    italics: false,
                                                    text: 'IMW - 10+ IGREJAS EM NÚMEROS DE MEMBROS',
                                                    fontSize: 14
                                                }],
                                                margin: [20, 20, 0, 0]
                                            };
