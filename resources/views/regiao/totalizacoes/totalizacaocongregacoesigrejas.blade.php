                            ...
                            <div class="row">
                                <div class="col-12">
                                    ...
                                    @include('regiao.partials.table-export-buttons', [
                                        'tableId' => 'total-congregacoes-igrejas-table',
                                        'title' => 'Total de Congregações por Igrejas - ' . $regiao->nome,
                                        'filename' => 'total-congregacoes-por-igrejas',
                                        'sheetName' => 'Congregações Igrejas',
                                    ])
                                    <div class="table-responsive">
                                        <table id="total-congregacoes-igrejas-table" class="table table-striped" style="font-size: 90%; margin-top: 15px;">
                                            <thead class="thead-dark">
                                                <tr>
                                                    <th style="text-align: left;">{{ __('Igrejas') }}</th>
                                                    <th style="text-align: center;">{{ __('Quantidade de Congregações') }}</th>
