    ...
    <div class="widget-header">
      <div class="row">
          <div class="col-xl-12 col-md-12 col-sm-12 col-12">
              <h4>{{ __('Relatório de Aniversariantes') }}</h4>
          </div>
      </div>
  </div>
      ...
      <form class="form-vertical" id="filter_form">
        ...
        <div class="form-group row mb-4">
          <div class="col-lg-2 text-right">
            <label class="control-label">{{ __('Onde congrega:') }}</label>
          </div>
          <div class="col-lg-6">
            <select id="congregacao_id" name="congregacao_id" class="form-control @error('congregacao_id') is-invalid @enderror" >
              <option value="" {{ old('congregacao_id') == '' ? 'selected' : '' }}>{{ __('TODOS') }}</option>
        ...
        <div class="form-group row mb-4">
          ...
          <div class="col-lg-6">
            <select id="mes" name="mes" class="form-control @error('mes') is-invalid @enderror" >
              <option value="" {{ old('mes') == '' ? 'selected hidden' : '' }}>{{ __('Selecione') }}</option>
              <option value="1" {{ old('mes') == '1' ? 'selected' : '' }}>{{ __('JANEIRO') }}</option>
              <option value="2" {{ old('mes') == '2' ? 'selected' : '' }}>{{ __('FEVEREIRO') }}</option>
              <option value="3" {{ old('mes') == '3' ? 'selected' : '' }}>{{ __('MARÇO') }}</option>
              <option value="4" {{ old('mes') == '4' ? 'selected' : '' }}>{{ __('ABRIL') }}</option>
              <option value="5" {{ old('mes') == '5' ? 'selected' : '' }}>{{ __('MAIO') }}</option>
              <option value="6" {{ old('mes') == '6' ? 'selected' : '' }}>{{ __('JUNHO') }}</option>
              <option value="7" {{ old('mes') == '7' ? 'selected' : '' }}>{{ __('JULHO') }}</option>
              <option value="8" {{ old('mes') == '8' ? 'selected' : '' }}>{{ __('AGOSTO') }}</option>
              <option value="9" {{ old('mes') == '9' ? 'selected' : '' }}>{{ __('SETEMBRO') }}</option>
              <option value="10" {{ old('mes') == '10' ? 'selected' : '' }}>{{ __('OUTUBRO') }}</option>
              <option value="11" {{ old('mes') == '11' ? 'selected' : '' }}>{{ __('NOVEMBRO') }}</option>
              <option value="12" {{ old('mes') == '12' ? 'selected' : '' }}>{{ __('DEZEMBRO') }}</option>
            </select>
          </div>
        </div>
