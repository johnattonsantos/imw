            ...
            <form class="form-vertical" id="filter_form" method="GET">
                ...
                <div class="form-group row mb-4">
                    ...
                    <div class="col-lg-6">
                        ...
                        <button id="btn_relatorio" data-url="{{ route('igreja.balancete-pdf', ['igreja' => $instituicao->id]) }}" type="button" name="action" value="relatorio" title="{{ __('Gerar Relatório') }}" class="btn btn-secondary btn">
                            {{ __('Relatório') }}
                        </button>
                    </div>
                </div>
