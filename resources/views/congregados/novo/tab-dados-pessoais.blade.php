  <div class="tab-pane fade show active" id="border-top-dados-pessoal" role="tabpanel" aria-labelledby="border-top-dados-pessoais">
    ...
    <div class="row mb-4">
      ...
      <div class="col-xl-3 text-center">
        ...
        <img src="{{ old('foto') ? asset(old('foto')) : asset('theme/images/sem-foto.jpg') }}" id="user-picture" class="rounded-circle img-fluid mb-3" alt="{{ __('Foto do usuário') }}" width="150px" height="150px;">
        <div>
      ...
      <div class="col-xl-9">
          <div class="form-group @error('nome') has-error @enderror">
            <div class="row mb-4">
              ...
              <div class="col-xl-3">
                ...
                <select class="form-control" id="novo_convertido" name="novo_convertido">
                  ...
                  <option value="S" {{ old('novo_convertido') == 'S' ? 'selected' : '' }}>{{ __('Sim') }}</option>
                  <option value="N" {{ old('novo_convertido') == 'N' ? 'selected' : '' }} selected>{{ __('Não') }}</option>
                </select>
            ...
            <div class="row mb-4">
              ...
              <div class="col-xl-4">
                ...
                <select class="form-control @error('estado_civil') is-invalid @enderror" id="estado_civil" name="estado_civil">
                  <option value="">{{ __('Selecione') }}</option>
                  <option value="S" {{ old('estado_civil') == 'S' ? 'selected' : '' }}>{{ __('Solteiro') }}</option>
                  <option value="C" {{ old('estado_civil') == 'C' ? 'selected' : '' }}>{{ __('Casado') }}</option>
                  <option value="D" {{ old('estado_civil') == 'D' ? 'selected' : '' }}>{{ __('Divorciado') }}</option>
                  <option value="V" {{ old('estado_civil') == 'V' ? 'selected' : '' }}>{{ __('Viúvo') }}</option>
                </select>
                @error('estado_civil')
                <span class="help-block text-danger">{{ $message }}</span>
                @enderror
            ...
            <div class="row mb-4">
              ...
              <div class="col-xl-3">
                <label for="documento_complemento">{{ __('Complemento Doc.') }}</label>
