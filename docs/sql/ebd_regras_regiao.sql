...
INSERT INTO `regras` (`id`, `nome`, `created_at`, `updated_at`, `deleted_at`) VALUES (NULL, 'regiao-ebd-estatisticas', current_timestamp(), current_timestamp(), NULL);
...
INSERT INTO `regras` (`id`, `nome`, `created_at`, `updated_at`, `deleted_at`) VALUES (NULL, 'regiao-menu-relatorio-ebd', current_timestamp(), current_timestamp(), NULL);


INSERT INTO `regras` (`id`, `nome`, `created_at`, `updated_at`, `deleted_at`) VALUES (NULL, 'regiao-ebd-dashboard', current_timestamp(), current_timestamp(), NULL);
...
FROM regras r
WHERE r.nome = 'regiao-menu-relatorio-ebd'
ORDER BY r.id DESC
LIMIT 1;
...
SELECT NULL, '3', r.id, current_timestamp(), current_timestamp()
FROM regras r
WHERE r.nome = 'regiao-ebd-dashboard'
ORDER BY r.id DESC
LIMIT 1;
...
SELECT NULL, '3', r.id, current_timestamp(), current_timestamp()
FROM regras r
WHERE r.nome = 'regiao-ebd-estatisticas'
ORDER BY r.id DESC
LIMIT 1;
