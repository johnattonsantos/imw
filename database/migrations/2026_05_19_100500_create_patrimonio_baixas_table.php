...
return new class extends Migration
{
    ...
    {
        Schema::create('patrimonio_baixas', function (Blueprint $table) {
            $table->id();
            ...
            $table->foreignId('risco_juridico_id')
                ->nullable()
                ->constrained('patrimonio_riscos_juridicos')
                ->nullOnDelete();

            $table->foreignId('benfeitoria_id')
                ->nullable()
                ->constrained('patrimonio_benfeitorias')
                ->nullOnDelete();
    ...
    {
        Schema::dropIfExists('patrimonio_baixas');
    }
};
