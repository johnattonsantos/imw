...
return new class extends Migration
{
    public function up(): void
    {
        ...
        $sourceRuleId = DB::table('regras')
            ->where('nome', 'regiao-menu-relatorio')
        ...
        $rule = DB::table('regras')
            ->where('nome', 'regiao-relatorio-acompanhamento-validacoes')
            ->first();
        ...
        if ($rule) {
            ...
            $ruleId = (int) DB::table('regras')->insertGetId([
                'nome' => 'regiao-relatorio-acompanhamento-validacoes',
                'created_at' => $now,
                'updated_at' => $now,
                'deleted_at' => null,
            ]);
