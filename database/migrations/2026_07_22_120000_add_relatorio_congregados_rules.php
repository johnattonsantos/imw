...
return new class extends Migration
{
    public function up()
    {
        $this->createRuleWithProfiles(
            'relatorio-congregados',
            null,
            ['Pastor', 'Secretario', 'Administrador do Sistema']
        );

        $this->createRuleWithProfiles(
            'distrito-menu-relatorio-congregados',
            'distrito-menu-relatorio',
            ['Administrador Distrito']
        );

        $this->createRuleWithProfiles(
            'regiao-menu-relatorio-congregados',
    ...
    {
        $this->deleteRule('relatorio-congregados');
        $this->deleteRule('distrito-menu-relatorio-congregados');
        $this->deleteRule('regiao-menu-relatorio-congregados');
    }
